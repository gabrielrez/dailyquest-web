    ...
    <section class="mt-20 mb-12 max-w-sm mx-auto">
        ...
        <form class="mt-12 space-y-5" @submit.prevent="handleRegister">
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-white mb-2.5">Confirm Password</label>
        ...
        <p class="mt-5 text-[#A1A1AA] text-sm text-center">
            ...
            <router-link to="/login" class="text-white font-medium hover:underline">Login</router-link>
        </p>
    </section>
